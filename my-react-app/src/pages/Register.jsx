  ...
  return (
    <div className="min-h-screen grid place-items-center bg-slate-50 p-6">
      <motion.form
        ...
        // Form को 3D tilt इफ़ेक्ट दिया गया (जैसे Login पेज पर)
        whileHover={{ rotateX: 2, rotateY: -2, z: 5 }} 
        style={{ transformPerspective: 800 }} 
        className="w-full max-w-md bg-white shadow-2xl rounded-xl p-8 border border-slate-300" 
      >
        ...
        <div className="flex justify-center mb-8">
          <motion.div
            ...
            // 3D कंटेनर को एक आकर्षक स्टाइल दिया गया (जैसे Login पेज पर)
        ...
        <h2 className="text-3xl font-extrabold text-slate-900 mb-2 text-center">Create Your Vault</h2>
        <p className="text-center text-sm text-slate-500 mb-6">Start encrypting your files today.</p>
        ...
        <motion.button
          whileHover={{ scale: 1.03, boxShadow: '0 4px 15px rgba(99, 102, 241, 0.5)' }}
          whileTap={{ scale: 0.97 }}
          type="submit"
